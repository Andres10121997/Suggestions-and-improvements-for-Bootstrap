...
1.	Uso de la etiqueta `<dialog>`: Propongo reemplazar los modales, que actualmente se construyen con `<div>` y manipulación de `JavaScript`, con la etiqueta nativa de `<dialog>` en `HTML`. Esto tiene varias ventajas:
